...
```bash
node "/Users/qiqicute/Documents/z_cqmeng_file/local_repository/SlideTutor-AI-main/.codex/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
```bash
node "/Users/qiqicute/Documents/z_cqmeng_file/local_repository/SlideTutor-AI-main/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
